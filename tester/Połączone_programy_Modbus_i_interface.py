    ...
    def create_components_tab(self):
        ...
        def create_table_tab(file_path, tab_name):
            ...
            if file_path == "ind_1f.csv" or file_path == "ind_3f.csv":
                ...
                table.setHorizontalHeaderLabels(["Moc producenta [kVAr]", "Indukcyjność [mH]", "Moc obliczona [kVAr]"])
            elif file_path == "cond_1f.csv":
                table.setColumnCount(3)
                table.setHorizontalHeaderLabels(["Moc producenta [kVAr]", "Pojemność [uF]", "Moc obliczona [kVAr]"])
