...
class ClientDatabaseApp(QMainWindow):
    def __init__(self, config):
        ...
        self.table_view = self._setup_table_view()  # Utworzenie widoku przeniesione do metody
    ...
    def _setup_table_view(self):
        """Konfiguruje QTableView i włącza alternatywne kolorowanie."""
        view = QTableView()
        view.setModel(self.table_model)

        # WŁĄCZENIE ALTERNATYWNEGO KOLOROWANIA WIESZRY
...
if __name__ == "__main__":
    ...
    # Ustawienie stylów QSS dla alternatywnego kolorowania (biały/błękitny)
    style_sheet = """
    QTableView {
        /* Ustawienie białego tła dla wierszy domyślnych */
        background-color: white; 
        /* Ustawienie błękitnego tła dla wierszy alternatywnych */
        alternate-background-color: #E6F7FF; 
        gridline-color: #DDDDDD; /* Opcjonalnie: jaśniejsze linie siatki */
    }
    """
